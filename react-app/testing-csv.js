...
index.addObjects(updatedJson, (err, content) => console.log(`Successfully added ${chalk.red('JSON')}  data into algolia ${chalk.cyan(index.indexName)} index:`, content.objectIDs));
